...
- **How to lock** — right-click the card, **or** press `.` / Suppr on the numeric keypad while hovering it.
- **Auto-skip** — when every card in hand is locked or unaffordable, the turn auto-ends if you have the game's "End turn automatically" option enabled.
